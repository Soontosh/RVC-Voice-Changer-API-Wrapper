"""
Modified for 3b1b use case.
Original file: https://github.com/Mangio621/Mangio-RVC-Fork/blob/main/vc_infer_pipeline.py
"""
...
class VC(object):
    ...
    def get_f0(
        ...
        if f0_method == "pm":
            ...
            raise ValueError("f0_method " + f0_method + " not recognized. Refer to RVCAPI.infer docstring for valid f0 methods.")
