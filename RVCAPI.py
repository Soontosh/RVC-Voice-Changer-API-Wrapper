...
def infer(pth_file: str, input_file: str, output_file: str, feature_index: str, harvest_median_filter: int, mix_vol_envelope: float, feature_index_ratio: float, VCP: float,  speaker_id: int = 0, transpoition: float = 0, crepe_hop: int = 160, post_sample_rate: int = 0, f0_method: str = "rmvpe") -> str:
    """
    ...
    Parameters:
        ...
        VCP (float): Whether to use Voiceless Consonant Preservation (Less Artifact): 0.33 (Smaller number = more protection. 0.50 means Don't Use.) Default is (0.50)
